...
eject_shell(itemstack,user,"rangedweapons:leenfield_rld",1.0,"rangedweapons_rifle_reload_a","rangedweapons:empty_shell")
return itemstack
end,
})


minetest.register_tool("rangedweapons:leenfield_r", {
	rw_next_reload = "rangedweapons:leenfield_rr",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_leenfield_noclip.png",
})
minetest.register_tool("rangedweapons:leenfield_rr", {
	rw_next_reload = "rangedweapons:leenfield_rrr",
...
minetest.register_tool("rangedweapons:leenfield_rrr", {
	rw_next_reload = "rangedweapons:leenfield",
	load_sound = "rangedweapons_ww2bolt_rld",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_leenfield_rld.png",
})


minetest.register_tool("rangedweapons:leenfield_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons:leenfield",
...
minetest.register_tool("rangedweapons:leenfield", {
		description = "" ..core.colorize("#35cdff","lee enfield. \n") ..core.colorize("#FFFFFF", "Ranged damage:18 + 35/sec of bullet lifetime\n")..core.colorize("#FFFFFF", "Accuracy: 100%\n") ..core.colorize("#FFFFFF", "knockback: 15\n") ..core.colorize("#FFFFFF", "Critical chance: 30%\n") ..core.colorize("#FFFFFF", "Critical efficiency: x3\n") ..core.colorize("#FFFFFF", "Ammunition: 408 chey\n") ..core.colorize("#FFFFFF", "Rate of fire: 1.0\n") ..core.colorize("#FFFFFF", "Reload time: 2.0\n") ..core.colorize("#FFFFFF", "Zoom: 12x\n") ..core.colorize("#27a600", "The gun is loaded!\n") ..core.colorize("#FFFFFF", "Clip size: 4\n") ..core.colorize("#FFFFFF", "Enemy penetration:30%\n") ..core.colorize("#FFFFFF", "Block penetration:10%\n") ..core.colorize("#FFFFFF", "Gun type: Rifle\n") ..core.colorize("#FFFFFF", "Bullet velocity: 75"),
	range = 0,
	weapon_zoom = 7.5,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	inventory_image = "rangedweapons_leenfield.png",
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_leenfield_icon.png",
		gun_unloaded = "rangedweapons:leenfield_r",
		gun_cooling = "rangedweapons:leenfield_uld",
		gun_velocity = 75,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 2.0/4,
