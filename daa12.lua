...
minetest.register_tool("rangedweapons:daa12_r", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons:daa12_rr",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_daa12_rld.png",
})
minetest.register_tool("rangedweapons:daa12_rr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons:daa12_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_daa12.png",
})
minetest.register_tool("rangedweapons:daa12_rrr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons:daa12",
...
-------------------------------------------
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_daa12_icon.png",
		gun_unloaded = "rangedweapons:daa12_r",
		gun_velocity = 25,
		gun_accuracy = 40,
		gun_cooldown = 0.2,
		gun_reload = 1.5/4,
