minetest.register_craftitem("rangedweapons:plasmammo", {
	...
	RW_ammo_capabilities = {
		...
		ammo_visual = "sprite",
		ammo_texture = "rangedweapons_dogray.png",
