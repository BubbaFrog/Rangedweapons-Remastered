minetest.register_craftitem("rangedweapons:firework", {
	...
	RW_ammo_capabilities = {
		...
		ammo_visual = "sprite",
		ammo_texture = "rangedweapons_fireworks.png",
