...
eject_shell(itemstack,user,"rangedweapons:scout_rld",1.0,"rangedweapons_rifle_reload_a","rangedweapons:empty_shell")
return itemstack
end,
})


minetest.register_tool("rangedweapons:scout_r", {
	rw_next_reload = "rangedweapons:scout_rr",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_scout_noclip.png",
})
minetest.register_tool("rangedweapons:scout_rr", {
	rw_next_reload = "rangedweapons:scout_rrr",
...
minetest.register_tool("rangedweapons:scout_rrr", {
	rw_next_reload = "rangedweapons:scout",
	load_sound = "rangedweapons_rifle_reload_b",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_scout_rld.png",
})


minetest.register_tool("rangedweapons:scout_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons:scout",
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_scout_icon.png",
		gun_unloaded = "rangedweapons:scout_r",
		gun_cooling = "rangedweapons:scout_uld",
		gun_velocity = 75,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 2.0/4,
