minetest.register_craftitem("rangedweapons:magicbullet", {
	...
	RW_ammo_capabilities = {
		...
		ammo_visual = "sprite",
		ammo_texture = "rangedweapons_magicblt.png",
