...
minetest.register_tool("rangedweapons:xm106_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons:xm106_rr",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_xm106_rld.png",
})

minetest.register_tool("rangedweapons:xm106_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons:xm106_rrr",
	load_sound = "rangedweapons_rifle_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_xm106.png",
})

minetest.register_tool("rangedweapons:xm106_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons:xm106",
...
..core.colorize("#FFFFFF", "Enemy penetration: 25%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 55"),
	...
	RW_gun_capabilities = {
		...
		gun_crit = 12,
		gun_critEffc = 3.0,
		suitable_ammo = {{"rangedweapons:556mm",100}},
		gun_skill = {"heavy_skill",55},
		gun_magazine = "rangedweapons:drum_mag",
		gun_icon = "rangedweapons_xm106_icon.png",
		gun_unloaded = "rangedweapons:xm106_r",
		gun_velocity = 55,
		gun_accuracy = 70,
		gun_cooldown = 0.1,
		gun_reload = 2.0/4,
