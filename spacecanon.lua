...
RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons:spacecanon",
		power_velocity = 60,
		power_accuracy = 100,
		power_cooldown = 0.1,
		power_projectiles = 1,
		power_durability = 12500,
		power_sound = "rangedweapons_spacecanon",
	...
	inventory_image = "rangedweapons_spacecanon.png",
})
