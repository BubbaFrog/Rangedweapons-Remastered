	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_ppsh41_icon.png",
		gun_unloaded = "rangedweapons:ppsh41_r",
		gun_velocity = 25,
		gun_accuracy = 75,
		gun_cooldown = 0.14,
		gun_reload = 1.3/4,
