...
then
	...
	minetest.sound_play("rangedweapons_reload_a", {user})
		itemstack = "rangedweapons:stickbomb_nopin"
...
minetest.register_craftitem("rangedweapons:stickbomb_nopin", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "***HURRY UP AND THROW IT!!!***",
	range = 0,
	inventory_image = "rangedweapons_stickbomb_nopin.png",
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "rangedweapons:stickbomb")
			if obj then
...
minetest.register_globalstep(function(dtime, player, pos)
	...
	local pos = player:get_pos()
		if player:get_wielded_item():get_name() == "rangedweapons:stickbomb_nopin" then
...
local rangedweapons_grenade = {
	...
	textures = {"rangedweapons_stickbomb_nopin.png"},
	lastpos= {},
...
minetest.register_entity("rangedweapons:stickbomb", rangedweapons_grenade)
