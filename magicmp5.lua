...
minetest.register_tool("rangedweapons:magicmp5_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.20},
	description = "",
	rw_next_reload = "rangedweapons:magicmp5_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_magicmp5_rld.png",
})

minetest.register_tool("rangedweapons:magicmp5_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.20},
	description = "",
	rw_next_reload = "rangedweapons:magicmp5_rrr",
...
minetest.register_tool("rangedweapons:magicmp5_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.20},
	description = "",
	rw_next_reload = "rangedweapons:magicmp5",
	...
	RW_gun_capabilities = {
		...
		gun_unloaded = "rangedweapons:magicmp5_r",
		gun_velocity = 25,
		gun_accuracy = 74,
		gun_cooldown = 0.075,
		gun_reload = 1.0/4,
