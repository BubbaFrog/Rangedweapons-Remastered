...
minetest.register_tool("rangedweapons:mini14_rrr", {
	rw_next_reload = "rangedweapons:mini14",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_mini14_rld.png",
})


minetest.register_tool("rangedweapons:mini14_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons:mini14",
...
minetest.register_tool("rangedweapons:mini14", {
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_mini14_icon.png",
		gun_unloaded = "rangedweapons:mini14_r",
		gun_cooling = "rangedweapons:mini14_uld",
		gun_velocity = 75,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 2.0/4,
