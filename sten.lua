	...
	minetest.register_tool("rangedweapons:sten_r", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons:sten_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	inventory_image = "rangedweapons_sten_rld.png",
	groups = {not_in_creative_inventory = 1},
})
	minetest.register_tool("rangedweapons:sten_rr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons:sten_rrr",
	load_sound = "rangedweapons_reload_a",
	inventory_image = "rangedweapons_sten.png",
	groups = {not_in_creative_inventory = 1},
})
	minetest.register_tool("rangedweapons:sten_rrr", {
	wield_scale = {x=1.75,y=1.75,z=1.5},
	description = "",
	range = 0,
	inventory_image = "rangedweapons_sten.png",
	rw_next_reload = "rangedweapons:sten",
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_sten_icon.png",
		gun_unloaded = "rangedweapons:sten_r",
		gun_velocity = 25,
		gun_accuracy = 75,
		gun_cooldown = 0.14,
		gun_reload = 1.3/4,
