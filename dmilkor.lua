...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_dmilkor_icon.png",
		gun_unloaded = "rangedweapons:dmilkor_rld",
		gun_cooling = "rangedweapons:dmilkor",
		gun_velocity = 30,
		gun_accuracy = 96,
		gun_cooldown = 0.35,
		gun_reload = 0.75,
