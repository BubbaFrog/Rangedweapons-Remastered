	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_m3a1_icon.png",
		gun_unloaded = "rangedweapons:m3a1_r",
		gun_velocity = 25,
		gun_accuracy = 75,
		gun_cooldown = 0.14,
		gun_reload = 1.3/4,
