...
minetest.register_tool("rangedweapons:usas12_r", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons:usas12_rr",
	load_sound = "rangedweapons_rifle_clip_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_usas12_rld.png",
})
minetest.register_tool("rangedweapons:usas12_rr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons:usas12_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_usas12.png",
})
minetest.register_tool("rangedweapons:usas12_rrr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.4},
	description = "",
	rw_next_reload = "rangedweapons:usas12",
