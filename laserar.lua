...
RW_powergun_capabilities = {
		...
		power_critEffc = 2.0,
		power_skill = {"",1},
		power_cooling = "rangedweapons:laserar",
		power_velocity = 60,
		power_accuracy = 100,
		power_cooldown = 0.1,
		power_projectiles = 1,
	...
	inventory_image = "rangedweapons_laserar.png",
})
