...
minetest.register_tool("rangedweapons:mosinagant_rrr", {
	rw_next_reload = "rangedweapons:mosinagant",
	load_sound = "rangedweapons_ww2bolt_rld",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_mosinagant_rld.png",
})


minetest.register_tool("rangedweapons:mosinagant_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons:mosinagant",
...
minetest.register_tool("rangedweapons:mosinagant", {
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_mosinagant_icon.png",
		gun_unloaded = "rangedweapons:mosinagant_r",
		gun_cooling = "rangedweapons:mosinagant_uld",
		gun_velocity = 75,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 2.0/4,
