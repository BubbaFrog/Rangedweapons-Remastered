...
if rweapons_forceguns == "true" then
	dofile(modpath.."/forcegun.lua")                                       dofile(modpath.."/gravitygun.lua")
end
...
if rweapons_power_weapons == "true" then
	...
	dofile(modpath.."/laser_shotgun.lua")                                            dofile(modpath.."/bfg.lua")                                                        dofile(modpath.."/thunderblaster.lua")                                               dofile(modpath.."/flamethrower.lua")                                                 dofile(modpath.."/420blaster.lua")                                                dofile(modpath.."/atomicblaster.lua")                                          dofile(modpath.."/starwarspistol.lua")                                             dofile(modpath.."/starwarsmg.lua")                                             dofile(modpath.."/ww2flamethrower.lua")                                          dofile(modpath.."/modernflamethrower.lua")                                     dofile(modpath.."/demonicblaster.lua")                                           dofile(modpath.."/trollgun.lua")                                                dofile(modpath.."/alienblaster.lua")                                                dofile(modpath.."/laserar.lua")                                                dofile(modpath.."/needle.lua")                                              dofile(modpath.."/spacecanon.lua")                                                dofile(modpath.."/sword.lua")                                                    dofile(modpath.."/fireworks.lua")                                              dofile(modpath.."/infinitygauntlet.lua")                                          dofile(modpath.."/gasgun.lua")                                               dofile(modpath.."/tm2d.lua")                                                dofile(modpath.."/squirtgun.lua")                                                   dofile(modpath.."/freezeray.lua")                                                 dofile(modpath.."/railgun.lua")                                                     dofile(modpath.."/electricgun.lua")                                       dofile(modpath.."/pinkblaster.lua")                                         dofile(modpath.."/rainbowblaster.lua")                                    dofile(modpath.."/bluelasergun.lua")                                           dofile(modpath.."/redlasergun.lua")
dofile(modpath.."/lavalauncher.lua")
dofile(modpath.."/plasmagun.lua")
end
...
if rweapons_machine_pistols == "true" then
	...
	dofile(modpath.."/kriss_sv.lua")                                                  dofile(modpath.."/scorpian.lua")                                                    dofile(modpath.."/spyuzi.lua")                                                       dofile(modpath.."/mac10.lua")                                                     dofile(modpath.."/helluzi.lua")                                                      dofile(modpath.."/mp7.lua")                                                      dofile(modpath.."/diamondvector.lua")                                           dofile(modpath.."/spymac10.lua")
dofile(modpath.."/m12.lua")
end
...
if rweapons_auto_shotguns == "true" then
	...
	dofile(modpath.."/aa12.lua")                                                      dofile(modpath.."/usas12.lua")                                                  dofile(modpath.."/megashotty.lua")
end
...
if rweapons_revolvers == "true" then
	...
	dofile(modpath.."/taurus.lua")                                                    dofile(modpath.."/colt45.lua")                                                        dofile(modpath.."/hellrevolver.lua")                                                 dofile(modpath.."/webly.lua")                                                    dofile(modpath.."/goldrevolver.lua")                                                dofile(modpath.."/diamondrevolver.lua")
end
if rweapons_assault_rifles == "true" then
	dofile(modpath.."/m16.lua")
	dofile(modpath.."/g36.lua")
	dofile(modpath.."/ak47.lua")
	dofile(modpath.."/scar.lua")                                              dofile(modpath.."/hipoint.lua")                                                    dofile(modpath.."/draco.lua")                                                       dofile(modpath.."/ak74u.lua")                                                          dofile(modpath.."/kashlinkov.lua")                                            dofile(modpath.."/m14.lua")                                                          dofile(modpath.."/goldak.lua")                                                     dofile(modpath.."/hk417.lua")                                                    dofile(modpath.."/scarface.lua")                                            dofile(modpath.."/mlgrifle.lua")                                            dofile(modpath.."/mp44.lua")                                                       dofile(modpath.."/m4.lua")                                                          dofile(modpath.."/hk416.lua")                                                    dofile(modpath.."/sg550.lua")                                                     dofile(modpath.."/ak12.lua")                                              dofile(modpath.."/assaultnailgun.lua")
...
if rweapons_explosives == "true" then
	...
	dofile(modpath.."/hand_grenade.lua")                                           dofile(modpath.."/panzerschreck.lua")                                              dofile(modpath.."/bazooka.lua")                                                  dofile(modpath.."/piat.lua")                                               dofile(modpath.."/rocketlauncher.lua")                                                    dofile(modpath.."/gunofdeath.lua")                                        dofile(modpath.."/panzerfaust.lua")                                                 dofile(modpath.."/smaw.lua")                                                   dofile(modpath.."/stinger.lua")                                                   dofile(modpath.."/multirpg.lua")                                                          dofile(modpath.."/tgl.lua")                                               dofile(modpath.."/molotov.lua")                                             
end
