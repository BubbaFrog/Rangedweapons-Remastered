...
if rweapons_explosives == "true" then
	...
	dofile(modpath.."/hand_grenade.lua")                                           dofile(modpath.."/panzerschreck.lua")                                              dofile(modpath.."/bazooka.lua")                                                  dofile(modpath.."/piat.lua")                                               dofile(modpath.."/rocketlauncher.lua")                                                   dofile(modpath.."/panzerfaust.lua")                                                 dofile(modpath.."/smaw.lua")                                                   dofile(modpath.."/stinger.lua")                                                   dofile(modpath.."/multirpg.lua")                                                         dofile(modpath.."/tgl.lua")                                               dofile(modpath.."/molotov.lua")                                            
end
