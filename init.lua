...
if rweapons_power_weapons == "true" then
	...
	dofile(modpath.."/laser_shotgun.lua")                                            dofile(modpath.."/bfg.lua")                                                        dofile(modpath.."/thunderblaster.lua")                                               dofile(modpath.."/flamethrower.lua")                                                 dofile(modpath.."/420blaster.lua")                                                dofile(modpath.."/atomicblaster.lua")                                          dofile(modpath.."/starwarspistol.lua")                                             dofile(modpath.."/starwarsmg.lua")                                               dofile(modpath.."/froggygun.lua")                                                    dofile(modpath.."/ww2flamethrower.lua")                                          dofile(modpath.."/modernflamethrower.lua")                                     dofile(modpath.."/demonicblaster.lua")                                           dofile(modpath.."/trollgun.lua")                                                dofile(modpath.."/alienblaster.lua")                                                dofile(modpath.."/laserar.lua")                                                dofile(modpath.."/needle.lua")                                              dofile(modpath.."/spacecanon.lua")                                                dofile(modpath.."/sword.lua")                                                    dofile(modpath.."/fireworks.lua")                                              dofile(modpath.."/infinitygauntlet.lua")                                          dofile(modpath.."/gasgun.lua")                                               dofile(modpath.."/tm2d.lua")                                                dofile(modpath.."/squirtgun.lua")                                                   dofile(modpath.."/freezeray.lua")                                                 dofile(modpath.."/railgun.lua")                                                     dofile(modpath.."/electricgun.lua")                                       dofile(modpath.."/pinkblaster.lua")                                         dofile(modpath.."/rainbowblaster.lua")                                    dofile(modpath.."/bluelasergun.lua")                                           dofile(modpath.."/redlasergun.lua")
end
