...
then
	...
	minetest.sound_play("rangedweapons_reload_a", {user})
		itemstack = "rangedweapons:potato_nopin"
...
minetest.register_craftitem("rangedweapons:potato_nopin", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "***HOT POTATO HOT POTATO!!!***",
	range = 0,
	inventory_image = "rangedweapons_potato_nopin.png",
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "rangedweapons:potato")
			if obj then
...
minetest.register_globalstep(function(dtime, player, pos)
	...
	local pos = player:get_pos()
		if player:get_wielded_item():get_name() == "rangedweapons:potato_nopin" then
...
local rangedweapons_grenade = {
	...
	textures = {"rangedweapons_potato_nopin.png"},
	lastpos= {},
...
minetest.register_entity("rangedweapons:potato", rangedweapons_grenade)
