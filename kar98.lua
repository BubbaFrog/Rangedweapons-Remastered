...
minetest.register_tool("rangedweapons:kar98_rrr", {
	rw_next_reload = "rangedweapons:kar98",
	load_sound = "rangedweapons_ww2bolt_rld",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_kar98_rld.png",
})


minetest.register_tool("rangedweapons:kar98_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons:kar98",
...
minetest.register_tool("rangedweapons:kar98", {
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_kar98_icon.png",
		gun_unloaded = "rangedweapons:kar98_r",
		gun_cooling = "rangedweapons:kar98_uld",
		gun_velocity = 75,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 2.0/4,
