...
if  inv:contains_item("main", "rangedweapons:power_particle 40") then
		...
		inv:remove_item("main", "rangedweapons:power_particle 25")
			...
			if obj then
				minetest.sound_play("rangedweapons_gravitygun", {object=obj})
