...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_webly_icon.png",
		gun_unloaded = "rangedweapons:webly_rld",
		gun_cooling = "rangedweapons:webly",
		gun_velocity = 55,
		gun_accuracy = 95,
		gun_cooldown = 0.2,
		gun_reload = 0.4,
