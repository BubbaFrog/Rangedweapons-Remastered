...
minetest.register_tool("rangedweapons:diamondvector_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.15},
	description = "",
	rw_next_reload = "rangedweapons:diamondvector_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_diamondvector_rld.png",
})

minetest.register_tool("rangedweapons:diamondvector_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.15},
	description = "",
	rw_next_reload = "rangedweapons:diamondvector_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_diamondvector.png",
})

minetest.register_tool("rangedweapons:diamondvector_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.15},
	description = "",
	rw_next_reload = "rangedweapons:diamondvector",
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_diamondvector_icon.png",
		gun_unloaded = "rangedweapons:diamondvector_r",
		gun_velocity = 20,
		gun_accuracy = 60,
		gun_cooldown = 0.05,
		gun_reload = 0.9/4,
