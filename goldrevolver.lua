...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_goldrevolver_icon.png",
		gun_unloaded = "rangedweapons:goldrevolver_rld",
		gun_cooling = "rangedweapons:goldrevolver",
		gun_velocity = 55,
		gun_accuracy = 95,
		gun_cooldown = 0.2,
		gun_reload = 0.4,
