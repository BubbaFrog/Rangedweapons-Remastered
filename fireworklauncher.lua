minetest.register_tool("rangedweapons:fireworklauncher_rld", {
	...
	inventory_image = "rangedweapons_fireworklauncher_rld.png",
	RW_gun_capabilities = {
		gun_damage = {fleshy=20,knockback=35},
		gun_crit = 10,
		gun_critEffc = 3.0,
		suitable_ammo = {{"rangedweapons:firework",1}},
		gun_skill = {"",1},
		gun_icon = "rangedweapons_fireworklauncher_icon.png",
		gun_unloaded = "rangedweapons:fireworklauncher_rld",
		gun_cooling = "rangedweapons:fireworklauncher",
		gun_velocity = 25,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 1.0,
