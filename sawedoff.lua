...
minetest.register_tool("rangedweapons:sawedoff_rld", {
	stack_max= 1,
...
minetest.register_tool("rangedweapons:sawedoff_r", {
	...
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	rw_next_reload = "rangedweapons:sawedoff",
	load_sound = "rangedweapons_sawedoff_rld",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_sawedoff_rld.png",
})
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_sawedoff_icon.png",
		gun_unloaded = "rangedweapons:sawedoff_r",
		gun_cooling = "rangedweapons:sawedoff_rld",
		gun_velocity = 25,
		gun_accuracy = 94,
		gun_cooldown = 0.4,
		gun_reload = 0.5,
		...
		gun_sound = "rangedweapons_boomstick",
	},
