...
minetest.register_tool("rangedweapons:qsz92_rld", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons:qsz92",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_qsz92_rld.png",
})
minetest.register_tool("rangedweapons:qsz92_r", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "",
	rw_next_reload = "rangedweapons:qsz92",
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_qsz92_icon.png",
		gun_unloaded = "rangedweapons:qsz92_r",
		gun_cooling = "rangedweapons:qsz92_rld",
		gun_velocity = 25,
		gun_accuracy = 94,
		gun_cooldown = 0.4,
		gun_reload = 0.5,
