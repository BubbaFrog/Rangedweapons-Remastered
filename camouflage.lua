...
local function update_fence(pos)
    if minetest.get_node(pos).name:find("rangedweapons:camouflage") == nil then
        return
    end
    local sum = 0
    for i = 1, 4 do
    ...
    minetest.add_node(pos, {name = "rangedweapons:camouflage_"..sum})
end
...
for i = 1, 15 do
    ...
    local texture = "rangedweapons_camouflage.png"
    if cnt == 1 then
        texture = "rangedweapons_camouflage.png"
    end
    minetest.register_node("rangedweapons:camouflage_"..i, {
        drawtype = "nodebox",
        tile_images = {"rangedweapons_camouflage.png", "rangedweapons_camouflage.png", texture},
        paramtype = "light",
        groups = {cracky=2},
        drop = "rangedweapons:camouflage",
        node_box = {
            type = "fixed",
            fixed = take
        },
...
minetest.register_node("rangedweapons:camouflage", {
    description = "Camouflage Fence",
    tiles = {"rangedweapons_camouflage.png"},
    inventory_image = "rangedweapons_camouflage.png",
    wield_image = "rangedweapons_camouflage.png",
...
minetest.register_craft({
	output = "rangedweapons:camouflage 12",
	recipe = {
