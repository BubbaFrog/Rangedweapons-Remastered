...
minetest.register_tool("rangedweapons:spymac10_r", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "rangedweapons:spymac10_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_spymac10_rld.png",
})
minetest.register_tool("rangedweapons:spymac10_rr", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "rangedweapons:spymac10_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_spymac10.png",
})
minetest.register_tool("rangedweapons:spymac10_rrr", {
	stack_max= 1,
	wield_scale = {x=1.6,y=1.6,z=1.10},
	description = "",
	rw_next_reload = "rangedweapons:spymac10",
...
-------------------------------------------
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_spymac10_icon.png",
		gun_unloaded = "rangedweapons:spymac10_r",
		gun_velocity = 25,
		gun_accuracy = 72,
		gun_cooldown = 0.08,
		gun_reload = 1.2/4,
