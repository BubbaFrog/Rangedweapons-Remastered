...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_westernshotgun_icon.png",
		gun_unloaded = "rangedweapons:westernshotgun_rld",
		gun_cooling = "rangedweapons:westernshotgun_uld",
		gun_velocity = 18,
		gun_accuracy = 40,
		gun_cooldown = 0.8,
		gun_gravity = 5,
...
minetest.register_tool("rangedweapons:westernshotgun_uld", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	range = 0,
...
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"rangedweapons:westernshotgun_rld",0.8,"rangedweapons_none","rangedweapons:empty_shell")
return itemstack
end,
})
