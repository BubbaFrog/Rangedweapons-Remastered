...
..core.colorize("#FFFFFF", "Enemy penetration: 27%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 64"),
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_type99_icon.png",
		gun_unloaded = "rangedweapons:type99_r",
		gun_velocity = 64,
		gun_accuracy = 65,
		gun_cooldown = 0.09,
		gun_reload = 1.0,
