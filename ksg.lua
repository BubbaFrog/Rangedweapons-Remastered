...
minetest.register_tool("rangedweapons:ksg_uld", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	range = 0,
...
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"rangedweapons:ksg_rld",0.6,"rangedweapons_none","rangedweapons:empty_shell")
return itemstack
end,
})
