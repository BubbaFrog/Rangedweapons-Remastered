...
minetest.register_tool("rangedweapons:p90_r", {
	...
	inventory_image = "rangedweapons_p90_rld.png",
})
...
minetest.register_tool("rangedweapons:p90_rr", {
	...
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_p90.png",
})
...
minetest.register_tool("rangedweapons:p90_rrr", {
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_p90_icon.png",
