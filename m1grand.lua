...
minetest.register_tool("rangedweapons:m1grand_uld", {
	stack_max= 1,
	...
	inventory_image = "rangedweapons_m1grand.png",
	weapon_zoom = 7.5,
	on_use = function(user)
		minetest.sound_play("rangedweapons_empty", {user})
	end,
on_secondary_use = function(itemstack, user, pointed_thing)
eject_shell(itemstack,user,"rangedweapons:m1grand_rld",1.0,"rangedweapons_rifle_reload_a","rangedweapons:empty_shell")
return itemstack
end,
})
...
minetest.register_tool("rangedweapons:m1grand_r", {
	...
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_m1grand_noclip.png",
})
minetest.register_tool("rangedweapons:m1grand_rr", {
	rw_next_reload = "rangedweapons:m1grand_rrr",
...
minetest.register_tool("rangedweapons:m1grand_rrr", {
	rw_next_reload = "rangedweapons:m1grand",
	load_sound = "rangedweapons_ww2bolt_rld",
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_m1grand_rld.png",
})


minetest.register_tool("rangedweapons:m1grand_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=1.9,y=1.9,z=1.1},
	description = "",
	loaded_gun = "rangedweapons:m1grand",
...
minetest.register_tool("rangedweapons:m1grand", {
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_m1grand_icon.png",
		gun_unloaded = "rangedweapons:m1grand_r",
		gun_cooling = "rangedweapons:m1grand_uld",
		gun_velocity = 75,
		gun_accuracy = 100,
		gun_cooldown = 1.0,
		gun_reload = 2.0/4,
