...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_colt45_icon.png",
		gun_unloaded = "rangedweapons:colt45_rld",
		gun_cooling = "rangedweapons:colt45",
		gun_velocity = 55,
		gun_accuracy = 95,
		gun_cooldown = 0.2,
		gun_reload = 0.4,
