...
RW_powergun_capabilities = {
		...
		power_critEffc = 2.2,
		power_skill = {"",1},
		power_cooling = "rangedweapons:atomicblaster",
		power_velocity = 55,
		power_accuracy = 40,
		power_cooldown = 0.1,
		power_projectiles = 1,
		power_durability = 2000,
		power_sound = "rangedweapons_atomic",
