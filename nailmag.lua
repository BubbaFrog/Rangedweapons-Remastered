minetest.register_craftitem("rangedweapons:nailmag", {
	...
	RW_ammo_capabilities = {
		...
		ammo_visual = "sprite",
		ammo_texture = "rangedweapons_nail.png",
