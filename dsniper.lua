...
minetest.register_tool("rangedweapons:dsniper_rrr", {
	rw_next_reload = "rangedweapons:dsniper",
	load_sound = "rangedweapons_rifle_reload_b",
	range = 0,
	wield_scale = {x=2.1,y=2.1,z=1.2},
	description = "",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_dsniper_rld.png",
})


minetest.register_tool("rangedweapons:dsniper_rld", {
	stack_max= 1,
	range = 0,
	wield_scale = {x=2.1,y=2.1,z=1.2},
	description = "",
	loaded_gun = "rangedweapons:dsniper",
...
minetest.register_tool("rangedweapons:dsniper", {
...
RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_dsniper_icon.png",
		gun_unloaded = "rangedweapons:dsniper_r",
		gun_cooling = "rangedweapons:dsniper_uld",
		gun_velocity = 80,
		gun_accuracy = 100,
		gun_cooldown = 1.5,
		gun_reload = 2.5/4,
