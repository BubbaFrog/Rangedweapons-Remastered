...
minetest.register_tool("rangedweapons:hk417_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons:hk417_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_hk417_rld.png",
})

minetest.register_tool("rangedweapons:hk417_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons:hk417_rrr",
	load_sound = "rangedweapons_rifle_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_hk417.png",
})

minetest.register_tool("rangedweapons:hk417_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.3},
	description = "",
	rw_next_reload = "rangedweapons:hk417",
...
..core.colorize("#FFFFFF", "Enemy penetration: 10%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 35"),
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_hk417_icon.png",
		gun_unloaded = "rangedweapons:hk417_r",
		gun_velocity = 35,
		gun_accuracy = 75,
		gun_cooldown = 0.067,
		gun_reload = 1.0/4,
