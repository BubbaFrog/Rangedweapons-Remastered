...
then
    minetest.chat_send_player(user:get_player_name(), "" ..core.colorize("#ff0000","Grenades are prohibited in this area!"))
		...
		gtimer = 0
	minetest.sound_play("rangedweapons_bomb_lit", {user})
		itemstack = "rangedweapons:dynamite_nopin"
...
minetest.register_craftitem("rangedweapons:dynamite_nopin", {
	stack_max= 1,
	wield_scale = {x=1.1,y=1.1,z=1.05},
	description = "***HURRY UP AND THROW IT!!!***",
	range = 0,
	inventory_image = "rangedweapons_dynamite_nopin.png",
	...
	on_use = function(itemstack, user, pointed_thing)
		...
		if pos and dir and yaw then
			pos.y = pos.y + 1.6
			local obj = minetest.add_entity(pos, "rangedweapons:dynamite")
			if obj then
...
minetest.register_globalstep(function(dtime, player, pos)
	...
	local pos = player:get_pos()
		if player:get_wielded_item():get_name() == "rangedweapons:dynamite_nopin" then
...
local rangedweapons_grenade = {
	...
	textures = {"rangedweapons_dynamite_nopin.png"},
	lastpos= {},
...
minetest.register_entity("rangedweapons:dynamite", rangedweapons_grenade)
