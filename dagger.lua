...
RW_throw_capabilities = {
		...
		throw_texture = "rangedweapons:thrown_dagger",
...
dagStack = {name="rangedweapons:dagger",wear=(bullet.wear)+(65535/throwDur)}
minetest.add_item(bullet.object:get_pos(),dagStack) end end,
	},
