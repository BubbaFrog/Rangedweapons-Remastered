...
minetest.register_tool("rangedweapons:magicdeagle_rld", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	loaded_gun = "rangedweapons:magicdeagle",
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_magicdeagle_rld.png",
})
minetest.register_tool("rangedweapons:magicdeagle_r", {
	stack_max= 1,
	wield_scale = {x=1.25,y=1.25,z=1.5},
	description = "",
	range = 0,
	rw_next_reload = "rangedweapons:magicdeagle",
...
..core.colorize("#FFFFFF", "penetration: 15%\n")..core.colorize("#FFFFFF", "Bullet velocity: 50"),
	wield_scale = {x=1.25,y=1.25,z=1.5},
	range = 0,
	inventory_image = "rangedweapons_magicdeagle.png",
RW_gun_capabilities = {
		...
		gun_unloaded = "rangedweapons:magicdeagle_r",
		gun_cooling = "rangedweapons:magicdeagle_rld",
		gun_velocity = 50,
		gun_accuracy = 85,
		gun_cooldown = 0.7,
		gun_reload = 0.6/1,
