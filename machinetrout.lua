...
..core.colorize("#FFFFFF", "Enemy penetration: 27%\n") ..core.colorize("#FFFFFF", "Bullet velocity: 64"),
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_machinetrout_icon.png",
		gun_unloaded = "rangedweapons:machinetrout_r",
		gun_velocity = 64,
		gun_accuracy = 65,
		gun_cooldown = 0.09,
		gun_reload = 1.0,
		...
		gun_unload_sound = "rangedweapons_minigunspin",
		gun_sound = "rangedweapons_minigun",
	},
