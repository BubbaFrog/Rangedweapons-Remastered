...
minetest.register_tool("rangedweapons:mp7_r", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.20},
	description = "",
	rw_next_reload = "rangedweapons:mp7_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_mp7_rld.png",
})

minetest.register_tool("rangedweapons:mp7_rr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.20},
	description = "",
	rw_next_reload = "rangedweapons:mp7_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_mp7.png",
})

minetest.register_tool("rangedweapons:mp7_rrr", {
	stack_max= 1,
	wield_scale = {x=1.75,y=1.75,z=1.20},
	description = "",
	rw_next_reload = "rangedweapons:mp7",
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_mp7_icon.png",
		gun_unloaded = "rangedweapons:mp7_r",
		gun_velocity = 25,
		gun_accuracy = 74,
		gun_cooldown = 0.075,
		gun_reload = 1.0/4,
