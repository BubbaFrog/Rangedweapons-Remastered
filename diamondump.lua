...
minetest.register_tool("rangedweapons:diamondump_r", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons:diamondump_rr",
	load_sound = "rangedweapons_handgun_mag_in",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_diamondump_rld.png",
})
minetest.register_tool("rangedweapons:diamondump_rr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons:diamondump_rrr",
	load_sound = "rangedweapons_reload_a",
	range = 0,
	groups = {not_in_creative_inventory = 1},
	inventory_image = "rangedweapons_diamondump.png",
})
minetest.register_tool("rangedweapons:diamondump_rrr", {
	stack_max= 1,
	wield_scale = {x=1.9,y=1.9,z=1.25},
	description = "",
	rw_next_reload = "rangedweapons:diamondump",
...
-------------------------------------------
	...
	RW_gun_capabilities = {
		...
		gun_icon = "rangedweapons_diamondump_icon.png",
		gun_unloaded = "rangedweapons:diamondump_r",
		gun_velocity = 32,
		gun_accuracy = 79,
		gun_cooldown = 0.115,
		gun_reload = 1.25/4,
